...
if [ ! -d "/home/container/plugins/Skript/scripts/network/" ]; then
	...
	ssh-agent bash -c "ssh-add /home/container/ssh/id-rsa; git clone -b ${NS_GIT_BRANCH} --single-branch git@github.com:BTKStudios/network-skript.git /home/container/plugins/Skript/scripts/network/"
fi
